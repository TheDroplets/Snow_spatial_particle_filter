...
%
% Graphical post-processing --- ticks and labels
...
%   jarrow        - Adds an arrow to a plot.  [By R. S. Oldaker]
%
...
%   linestylsets  - User-specified line style sets for use with LINESTYLE.
%   fontsizesets  - User-specified fontsize sets for use with FONTSIZE  
%   colorsets     - User-defined color sets for use with LINESTYLE.
%
